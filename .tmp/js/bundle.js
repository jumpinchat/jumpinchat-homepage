(function () {
	...
	/* global document */
	var profileButton = jquery('#profile-drop-trigger');
	var profileDropdown = jquery('#profile-drop-container');
	var newButton = jquery('#new');

	if (profileButton.length) {
	  var profileTether = new tether({
	...
	var removeModButton = jquery('.settings__RoomModRemove');

	var removeMod = function removeMod(username, element) {
	  jquery.ajax({
	    method: 'delete',
	...
	var userIgnoreRemove = jquery('.settings__UserIgnoreRemove');

	var removeIgnore = function removeIgnore(id, username, element) {
	  jquery.ajax({
	    method: 'delete',
	...
	var resendButton = jquery('#send-verification-email');
	var isVerifiedString = jquery('#is-verified-string');
	...
	var usernameInput = jquery('#register-form [name="username"]');
	var usernameText = jquery('#register-form .register__UsernameText');
	var registerSubmit = jquery('#register-form [type="submit"]');

	var checkUsername = function checkUsername(username, cb) {
	  jquery.ajax({
	    method: 'get',
	...
	usernameInput.on('change', function onUsernameInputChange() {
	  var elem = jquery(this);
	  checkUsername(elem.val(), function (data) {
	    if (data && data.error) {
	...
	jquery(document).ready(function () {
	  var timeElements = jquery('time.convertDate');
	...
	jquery(document).ready(function () {
	  var button = jquery('button.disableOnClick');
	...
	function () {
	  function ImageUpload() {
	    var elemSelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.imageUpload__Form';
	  ...
	  _createClass(ImageUpload, [{
	    ...
	    value: function createImageUpload() {
	      ...
	      if (this.isAdvancedUpload()) {
	        var $elem = jquery(this.targetElement);
	        var $form = $elem;
	        var $container = jquery("".concat(this.elemSelector, " .imageUpload__Container"));
	        var $input = jquery("".concat(this.elemSelector, " .imageUpload__File"));
	        var $submit = jquery("".concat(this.elemSelector, " .imageUpload__UploadButton"));
	        var $loading = jquery("".concat(this.elemSelector, " .imageUpload__Loading"));
	        var $statusSuccess = jquery("".concat(this.elemSelector, " .imageUpload__Status--success"));
	        var $statusError = jquery("".concat(this.elemSelector, " .imageUpload__Status--error"));
	        ...
	        $elem.on('drag dragstart dragend dragover dragenter dragleave drop', function (e) {
	          ...
	          _this.file = e.originalEvent.dataTransfer.files[0];

	          _this.reader.readAsDataURL(_this.file);
	        });
	        $input.on('change', function (e) {
	          _this.file = e.originalEvent.target.files[0];

	          _this.reader.readAsDataURL(_this.file);
	        });
	        this.reader.addEventListener('load', function () {
	          var preview = _this.targetElement.querySelector('.imageUpload__Preview');

	          $submit.addClass('imageUpload__UploadButton--visible');
	          $elem.find('.imageUpload__Label').addClass('imageUpload__Label--hasImage');
	          preview.src = _this.reader.result;
	          _this.cropper = new cropper(preview, {
	    ...
	    value: function isAdvancedUpload() {
	      ...
	      var draggable = 'draggable' in elem || 'ondragstart' in elem && 'ondrop' in elem;
